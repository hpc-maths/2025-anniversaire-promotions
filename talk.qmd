...
:::{.text-center .color-0 .h1 .display-3}
...
- Nouvelle approche aux grandes échelles - ondelettes à div. nulle
...
- Géom. différentielle / modèles cinétiques
:::
::::
:::
...
- Implémentation dans un samurai : résolution de plusieurs décades de questions qui se posaient sur l’utilisation de maillage adaptés
...
::::
::::{.col .text-center .align-self-center}
<video class="video-responsive-30" data-autoplay loop src="videos/LBM_Landing_Gear_NASA.mov">
</video>
