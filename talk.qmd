...
- Erreur de consistance et contrainte de stabilité
$$
err = \mathcal{O}\left(\frac{\Delta x}{\color{red}\epsilon}\right) \quad \Delta t \leq \color{red}\epsilon \Delta x
$$
$$
\color{red}\epsilon = 10^{-4} \quad \Delta x \leq 10^{-6} \quad \Delta x \leq 10^{-10}
$$
...
$$
\begin{align}
\partial_t E + \frac{1}{\epsilon} \partial_x F &= 0 \\
\partial_t F + \frac{1}{\epsilon} \partial_x E &  = -\frac{\sigma}{\epsilon^2}F
\end{align}
$$
::::
:::
...
:::{.row}
<video class="video-responsive" data-autoplay loop src="videos/ElectronDensity_converted.mp4"></video>
...
:::{.row}
<video class="video-responsive" data-autoplay loop src="videos/ElectronFlux_converted.mp4"></video>
::::{.text-center}
flux électron
::::
:::
